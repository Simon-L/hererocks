-- Test file used in CI to test the installation is correct on all platform
...
get("http://example.com/index.html", "index.html")

print("END Testing Socket")

print("BEGIN Testing posix (Unix only)")

if (jit.os ~= "Windows") then
  local unistd = require "posix.unistd"
  print("PID:", unistd.getpid())
end

print("END Testing posix (Unix only)")

print("BEGIN Testing inspect and penlight")
local inspect = require "inspect"
local app = require "pl.app"
a, b = app.lua()
print(inspect(a, b))
print(app.appfile("testfile.txt"))
print("END Testing inspect and penlight")
